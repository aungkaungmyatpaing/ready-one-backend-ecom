<!-- ========== App Menu ========== -->
<div class="app-menu navbar-menu" style="background: #1C3522">
    <!-- LOGO -->
    <div class="navbar-brand-box my-md-2" style="background: none">
        <!-- Dark Logo-->
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link menu-link {{ request()->url() == route('category') ? 'active' : ''}}" href="{{route('category')}}">
                        <i class="ri-stack-line"></i> <span data-key="t-landing">Main Categories</span>
                    </a>
                </li>

                <li class="nav-item ">
                    <a class="nav-link menu-link {{ request()->url() == route('sub.category') ? 'active' : ''}}" href="{{route('sub.category')}}">
                        <i class="ri-stack-line"></i> <span data-key="t-landing">Sub Categories</span>
                    </a>
                </li>
