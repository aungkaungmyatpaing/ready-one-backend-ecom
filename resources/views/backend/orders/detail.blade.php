                    ...
                    <table class="table table-nowrap align-middle table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    {{$item['product'] ?\App\Models\Category::find($item['product']['category_id'])->name  : '---' }}
                                </td>
                                <td>
                                    {{$item['product'] ? (\App\Models\SubCategory::find($item['product']['sub_category_id']) ? \App\Models\SubCategory::find($item['product']['sub_category_id'])->name : '---') : '---'}}
                                </td>
                                <td>
