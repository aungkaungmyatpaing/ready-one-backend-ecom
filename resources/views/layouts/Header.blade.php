@php
    $customers = auth()->user()->unreadNotifications->where('type','App\Notifications\NewCustomerRegisterNotification');
    $orders = auth()->user()->unreadNotifications->where('type','App\Notifications\NewOrderNotification');
    $cCount = 0;
    $oCount = 0;
    foreach($customers as $noti){
        !$noti->is_read ? $cCount++ : '';
    }
    foreach($orders as $noti){
        !$noti->is_read ? $oCount++ : '';
    }
@endphp
<header id="page-topbar">
    <div class="layout-width">
        <div class="navbar-header" style="background: #1C3522">
            <div class="d-flex">
                <!-- LOGO -->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @if ($cCount+ $oCount)
                            <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">{{ $cCount+ $oCount}}<span class="visually-hidden">unread messages</span></span>
                        @endif
                    </button>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 overflow-hidden" aria-labelledby="page-header-notifications-dropdown" style="border-color:transparent;border-radius: 15px">
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge badge-soft-light fs-13">{{ $cCount+ $oCount}} New</span>
                                    </div>
                                </div>
                            </div>
                            <div class="px-2 pt-2">
                                <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true" id="notificationSubscriberTab" role="tablist">
                        ...
                        <div class="tab-content" id="notificationItemsTabContent" style="max-height: 300px; overflow-y: scroll;overflow-x: hidden;">
                            <div class="tab-pane fade p-1 active show" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                <div data-simplebar id="orders" style="max-height: 300px;" class="">
                                    @if ($oCount != 0)
                                        @foreach ($orders as $noti)
                            ...
                            <div class="tab-pane fade p-1 " id="all-noti-tab" role="tabpanel" aria-labelledby="all-noti-tab">

                                <div data-simplebar id="customers" style="max-height: 300px;" class="">
                                        ...
                                        @foreach ($customers as $noti)
                                            <div class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1">
                                                        <a href="{{ route('customer.detail',['customer'=>$noti->data['customer_id'],'notiId'=>$noti->id]) }}" class="stretched-link">
                                                            <h6 class="mt-0 mb-2 fs-13 lh-base"><b class="text-success">{{ $noti->data['name'] }}</b> {{$noti->data['message']}}
                                                            </h6>
                                                        </a>
                                                        <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user" style="background: #1C3522">
