...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg">
    ...
    <body>
           ...
           <div class="auth-page-wrapper auth-bg-cover py-5 d-flex justify-content-center align-items-center min-vh-100">
            <div class="bg-overlay" style="background:#eee"></div>
            <!-- auth-page content -->
            <div class="auth-page-content overflow-hidden pt-lg-5">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card overflow-hidden border-0 shadow-sm" style="border-radius: 15px;">
                                <div class="row g-0">
                                    <div class="col-lg-6" style="background-color: #1C3522;">
                                        ...
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="mt-4">
                                                <form action="{{ route('postLogin') }}" method="POST">
                                                    ...
                                                    <div class="mt-4">
                                                        <button class="btn btn-success w-100 border-0" style="background: #000" type="submit">Sign In</button>
                                                    </div>
                                                </form>
                                            </div>
