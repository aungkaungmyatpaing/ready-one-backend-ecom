        ...
        <div class="card my_card">
            ...
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('sub.category.store')}}" id="category_create" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label mb-3">အမည်</label>
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\storeSubCategoryRequest', '#category_create') !!}
