...
<div class="card my_card">
        <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
            <h5 class="mb-0 text-dark">Sub Catgories - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\SubCategory::count() }}</div></h5>
            <a class="primary_button" href="{{route('sub.category.create')}}">
                <div class="d-flex align-items-center">
                    <i class=" ri-add-circle-fill mr-2 primary-icon"></i>
                    <span class="button_content">Sub Category အသစ်ဖန်တီးမည်</span>
                </div>
            </a>
        </div>
            ...
            <div class="table-responsive">
                <table class="table" id="datatable" style="width:100%;">
                    <thead class="text-center bg-light text-muted">
                        ...
                        <th class="text-center no-sort">Main Category</th>
