            ...
            <div class="table-responsive">
                <table class="table table-hover" id="datatable" style="width:100%;">
                    <thead class="text-center text-muted" style="background: #F3F6F9">
                        ...
                        <th class="text-center no-sort">အလေးချိန်</th>
                        <th class="text-center no-sort no-search">အမျိူးအစား / Category</th>
                        <th class="text-center no-sort no-search">Sub Category</th>
      ...
      $(document).ready(function() {
            let table = $('#datatable').DataTable( {
                ...
                columns : [
                  ...
                  {data: 'weight', name: 'weight', class: 'text-center'},
                  {data: 'category', name: 'category', class: 'text-center'},
                  {data: 'subCategory', name: 'subCategory', class: 'text-center'},
